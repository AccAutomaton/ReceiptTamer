...
class InvoiceTable {
  ...
  Future<int> delete(int id) async {
    try {
      ...
      logService.i(LogConfig.moduleDb, '发票已删除: id=$id, rowsAffected=$count');
      return count;
    } catch (e, stackTrace) {
      logService.e(LogConfig.moduleDb, '发票删除失败', e, stackTrace);
      rethrow;
    }
  }
  ...
  Future<int> deleteAll() async {
    try {
      final count = await database.delete(AppConstants.invoicesTable);
      logService.i(LogConfig.moduleDb, '所有发票已删除: count=$count');
      return count;
    } catch (e, stackTrace) {
      logService.e(LogConfig.moduleDb, '删除所有发票失败', e, stackTrace);
      rethrow;
    }
  }
  ...
  Future<Invoice?> getById(int id) async {
    try {
      ...
      logService.e(LogConfig.moduleDb, '获取发票失败: id=$id', e, stackTrace);
      rethrow;
    }
  }
  ...
  Future<List<Invoice>> getAll({int? limit, int? offset}) async {
    try {
      ...
      logService.e(LogConfig.moduleDb, '获取所有发票失败', e, stackTrace);
      rethrow;
    }
  }
  ...
  Future<List<Invoice>> getByDateRange(DateTime start, DateTime end) async {
    try {
      ...
      logService.e(LogConfig.moduleDb, '按日期范围获取发票失败', e, stackTrace);
      rethrow;
    }
  }
  ...
  Future<List<Invoice>> getTodayInvoices() async {
    try {
      ...
      logService.e(LogConfig.moduleDb, '获取今日发票失败', e, stackTrace);
      rethrow;
    }
  }
  ...
  Future<List<Invoice>> getWithoutOrders() async {
    try {
      ...
      logService.e(LogConfig.moduleDb, '获取未关联订单的发票失败', e, stackTrace);
      rethrow;
    }
  }
  ...
  Future<double> getTotalAmount() async {
    try {
      ...
      logService.e(LogConfig.moduleDb, '获取发票总金额失败', e, stackTrace);
      rethrow;
    }
  }
  ...
  Future<double> getTotalAmountByDateRange(DateTime start, DateTime end) async {
    try {
      ...
      logService.e(LogConfig.moduleDb, '按日期范围获取发票总金额失败', e, stackTrace);
      rethrow;
    }
  }
  ...
  Future<int> getCount() async {
    try {
      ...
      logService.e(LogConfig.moduleDb, '获取发票数量失败', e, stackTrace);
      rethrow;
    }
  }
  ...
  Future<List<Invoice>> search({
    ...
    try {
      ...
      logService.e(LogConfig.moduleDb, '搜索发票失败', e, stackTrace);
      rethrow;
    }
  }
  ...
  Future<List<Map<String, dynamic>>> getWithOrderInfo() async {
    try {
      ...
      logService.e(LogConfig.moduleDb, '获取发票(含订单信息)失败', e, stackTrace);
      rethrow;
    }
  }
  ...
  Future<List<Map<String, dynamic>>> getSellerNamesWithCount() async {
    try {
      ...
      logService.e(LogConfig.moduleDb, '获取销售方名称统计失败', e, stackTrace);
      rethrow;
    }
  }
}
