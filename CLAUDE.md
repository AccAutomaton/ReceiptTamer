...
- 当你想使用python命令时，不要使用 `python3` ，直接使用 `python` 。
...
- **最小影响**：只修改必要部分，避免引入新 bug。
  ————————————————
  版权声明：本文为CSDN博主「紫微AI」的原创文章，遵循CC 4.0 BY-SA版权协议，转载请附上原文出处链接及本声明。
  原文链接：https://blog.csdn.net/weixin_48708052/article/details/158290098